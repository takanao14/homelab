...
inputs = {
  vms = {
    "sandbox-k0s-cp1" = merge(local.base_vars, {
      cores  = 2
      memory = 4096
    ...
    "sandbox-k0s-worker1" = merge(local.base_vars, {
      cores  = 4
      memory = 4096
      bridge = local.common.locals.dev.net20.bridge
      ipv4gw = local.common.locals.dev.net20.ipv4gw
    ...
    "sandbox-k0s-worker2" = merge(local.base_vars, {
      cores  = 4
      memory = 4096
      bridge = local.common.locals.dev.net20.bridge
      ipv4gw = local.common.locals.dev.net20.ipv4gw
    ...
    "sandbox-k0s-worker3" = merge(local.base_vars, {
      cores  = 4
      memory = 4096
      bridge = local.common.locals.dev.net20.bridge
      ipv4gw = local.common.locals.dev.net20.ipv4gw
